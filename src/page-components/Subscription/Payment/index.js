...
const Plan = () => {
    ...
    const { mutate: verifyTransaction, isLoading } = useMutation({
        mutationFn: Client.subscription.verify_paystack, 
        onSuccess: (data) => {
            if (data.error) {
                                                ...
                                                <Col sm='12' md='9'>
                                                    <div className='payment-gateway__card'>
                                                        <div className='d-flex align-items-center payment-gateway_company'>
                                                            {/* <img src={pay1} /> */}
                                                            <Image src={'/assets/img/pay1.svg'} alt='icon' height={40} width={40} />
                                            ...
                                            <Row className='g-3'>
                                                ...
                                                <Col sm='12' md='6'>
                                                    <div className='payment-gateway__card'>
                                                        <div className='d-flex align-items-center payment-gateway_company'>
                                                            {/* <img src={pay3} /> */}
                                                            <Image src={'/assets/img/pay3.svg'} alt='icon' height={40} width={40} />
