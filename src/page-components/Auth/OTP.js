...
const OTP = () => {
    const userEmail = Cookies.get("GENTI_NEW_USER_EMAIL")
    ...
    const { mutate: verifyOTP, isLoading: verifying } = useMutation({
        ...
        onSuccess: () => {
            Cookies.remove("GENTI_NEW_USER_EMAIL")
    ...
    return (
        <div className='bg-gradient-to-b from-[#12121296] to-[#101010fa] rounded-4xl flex items-center justify-center'>
            {
                !verificationSuccess ?
                    <div className='auth-form w-[100%] px-24 py-6 h-[calc(81vh - 23px)] mt-[23px] relative mobile-form' autoComplete='off' >
                        <div className='mb-3 '>
                    ...
                    :
                    <form className='auth-form w-[100%] px-6 py-6 h-[calc(81vh - 23px)] mt-[23px] relative mobile-form'>
                        <div className='animation-wrapper mt-[50.2px] mb-[20px]'>
                            <Success />
                        </div>
                        <p className='congrats-text font-[500] text-[18px] leading-[29px] text-center text-white'>Congratulations! </p>
                        <p className='congrats-sub-text font-normal text-[13px] leading-[21px] text-center text-[#C4C4C4] w-[75%] mx-auto mt-0 mb-[48px]'>You have successfully signed up on Genti platform.</p>
                        <div className='sign-in-btn w-[100%]'>
                            <button className='btn auth-btn bg-gradient-to-r from-[#5F42E2] to-[#9B42C0] rounded-[100px] font-[500] text-[14px] leading-[22px] text-center text-white py-[14px] w-full  ' onClick={(e) => {
                                e.preventDefault()
